"""Sensor platform for quatt local API."""
...
async def async_setup_entry(hass: HomeAssistant, entry, async_add_devices):
    """Set up the local sensor platform."""
...
class QuattLocalSensor(QuattEntity, SensorEntity):
    """quatt Local Sensor class."""
